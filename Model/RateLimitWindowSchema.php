...
/**
 * RateLimitWindowSchema Class Doc Comment
 *
 * @category Class
 * @package  ArtifactsMmo
 * @author   OpenAPI Generator team
 ...
 */
class RateLimitWindowSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RateLimitWindowSchema';
     ...
     * Sets limit
     *
     * @param int $limit Maximum requests allowed in this window.
     *
     * @return self
     */
     ...
     * Sets reset
     *
     * @param \DateTime $reset UTC datetime when the window resets.
     *
     * @return self
     */
